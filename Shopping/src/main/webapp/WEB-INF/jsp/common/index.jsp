...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="<%=request.getContextPath()%>/js/index.jsp">乳酸菌平台系统</a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              ...
              <dd><a href="<%=request.getContextPath()%>/syslogin/loginjsp">退出</a></dd>
            </dl>
          </li>
          <li class="layui-nav-item to-index"><a href="<%=request.getContextPath()%>/jsp/index.jsp">前台首页</a></li>
        </ul>
